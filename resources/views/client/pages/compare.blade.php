        ...
        <div class="page-content">
            <table class="table table-bordered table-compare">
                <tr>
                    ...
                    <td>
                        <a href="#"><img src="{{URL::to('public/asset_client/data/p40.jpg')}}" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{URL::to('public/asset_client/data/p42.jpg')}}" alt="Product"></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{URL::to('public/asset_client/data/p41.jpg')}}" alt="Product"></a>
                    </td>
