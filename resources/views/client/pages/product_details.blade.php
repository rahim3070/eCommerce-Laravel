...
<!--            <span class="navigation-pipe">&nbsp;</span>
            ...
            <span class="navigation-pipe">&nbsp;</span>
            <span class="navigation_page">{{$category_info[0]->category_name}}</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
                    ...
                    <div class="primary-box row">
                        <div class="pb-left-column col-xs-12 col-sm-5">
                            ...
                            <div class="product-image">
                                @if($c_info->image_level == 1)
                                <div class="product-full">
                                    <!--<img id="product-zoom" src='{{URL::to('public/asset_client/data/product-s3-420x512.jpg')}}' data-zoom-image="{{URL::to('public/asset_client/data/product-s3-850x1036.jpg')}}"/>-->
                                    <img id="product-zoom" src='{{URL::to($c_info->image_option)}}' data-zoom-image="{{URL::to($c_info->image_option)}}"/>
                                </div>
                                <?php
                                $sub_category = DB::table('tbl_ecks_product_image')
                                        ->where('product_id', $c_info->product_id)
                                        ->where('image_level', 0)
                                        ->select('image_option', 'image_level')
                                        ->get();
                                ?>
                                <div class="product-img-thumb" id="gallery_01">
                                    <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="21" data-loop="true">
                                        ...
                                        <li>
                                            <a href="#" data-image="{{URL::to($sc_info->image_option)}}" data-zoom-image="{{URL::to($sc_info->image_option)}}">
                                                <img id="product-zoom"  src="{{URL::to($sc_info->image_option)}}" /> 
                                            </a>
                                        </li>
                                        @endforeach
                                    </ul>
                        ...
                        <div class="pb-right-column col-xs-12 col-sm-7">
                            <h1 class="product-name">{{$c_info->product_name}}</h1>
                            ...
                            <div class="product-price-group">
                                <span class="price">{{$c_info->new_price}}</span>
                                <span class="old-price">{{$c_info->old_price}}</span>
                                <span class="discount">-30%</span>
                            </div>
                            <div class="info-orther">
                                <p>Item Code: {{$c_info->product_id}}</p>
                                <p>Availability: <span class="in-stock">In stock</span></p>
                                <p>Condition: New</p>
                            </div>
                            <div class="product-desc">
                                {{$c_info->short_description}}
                            </div>
                            <div class="form-option">
                                ...
                                {!! Form::open(['url' => '/add-to-cart/'.$c_info->product_id,'method'=>'post']) !!}
                                <div class="attributes">
                                    <div class="attribute-label">Qty:</div>
                                    <div class="attribute-list product-qty">
                                        <div class="qty">
                                            <input id="option-product-qty" type="text" name="qty" value="1">
                                            <input id="option-product-qty" type="hidden" name="product_id" value="{{$c_info->product_id}}">
                                        </div>
                                        <div class="btn-plus">
                                ...
                                <div class="attributes">
                                    ...
                                    <div class="attribute-list">
                                        ...
                                        <a id="size_chart" class="fancybox" href="{{URL::to('public/asset_client/data/size-chart.jpg')}}">Size Chart</a>
                                    </div>
                        ...
                        <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p40.jpg')}}" />
                                        </a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p35.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p37.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p39.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                        ...
                        <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p97.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p34.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
                            ...
                            <li>
                                <div class="product-container">
                                    <div class="left-block">
                                        <a href="#">
                                            <img class="img-responsive" alt="product" src="{{URL::to('public/asset_client/data/p36.jpg')}}" />
                                        </a>
                                        <div class="quick-view">
                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                            <a title="Add to compare" class="compare" href="#"></a>
