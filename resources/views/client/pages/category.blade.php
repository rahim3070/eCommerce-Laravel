                        ...
                        <ul class="testimonials owl-carousel" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplay="true" data-autoplayHoverPause = "true" data-items="1">
                            <li>
                                ...
                                <div class="client-avarta">
                                    <img src="{{URL::to('public/asset_client/data/testimonial.jpg')}}" alt="client-avarta">
                                </div>
                ...
                <!--                 category-slider 
                                <div class="category-slider">
                                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                                        <li>
                                            <img src="{{URL::to('public/asset_client/data/category-slide.jpg')}}" alt="category-slider">
                                        </li>
                                        <li>
                                            <img src="{{URL::to('public/asset_client/data/slide-cart2.jpg')}}" alt="category-slider">
                                        </li>
                                    </ul>
                                </div>
                                 ./category-slider -->
                        ...
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="{{URL::to('product-details/'.$c_info->product_id)}}">
                                        <img class="img-responsive" alt="product" src="{{URL::to($c_info->image_option)}}" />
                                    </a>
                                    ...
                                    <div class="add-to-cart">
                                        <a title="Add to Cart" href="{{URL::to('add-to-cart/'.$c_info->product_id)}}">Add to Cart</a>
                                    </div>
<!--                                    {!! Form::open(['url' => '/add-to-cart','method'=>'post']) !!}
                                ...
                                <div class="right-block">
                                    <h5 class="product-name"><a href="#">{{$c_info->product_name}}</a></h5>
                                    ...
                                    <div class="content_price">
                                        <span class="price product-price">{{$c_info->new_price}}</span>
                                        <span class="price old-price">{{$c_info->old_price}}</span>
                                    </div>
