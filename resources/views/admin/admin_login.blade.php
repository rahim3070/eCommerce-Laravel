...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Kute Shop Admin</title>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="{{URL::to('public/asset_admin/css/ace.min.css')}}" />
        <!--[if lte IE 9]>
                <link rel="stylesheet" href="{{URL::to('public/asset_admin/css/ace-part2.min.css')}}" />
        <![endif]-->
        <link rel="stylesheet" href="{{URL::to('public/asset_admin/css/ace-rtl.min.css')}}" />
        <!--[if lte IE 9]>
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Kute Shop</span>
                                    <span class="white" id="id-text2">Admin</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; Ecommerce Website</h4>
                            </div>
