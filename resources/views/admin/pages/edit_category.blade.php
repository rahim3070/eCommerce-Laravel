                ...
                <div class="col-xs-12 widget-container-col">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h5 class="widget-title">Edit Category ...</h5>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                ...
                                <div class="row">
                                    ...
                                    {!! Form::open(['url' => '/update-category','method'=>'post','name'=>'edit_category','enctype'=>'multipart/form-data']) !!}
                                    <div class="col-xs-12">
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="col-md-4" for="form-field-1">Category Name</label>
                                            <div class="col-md-8">
                                                <input name='category_id' value='<?php echo $category_info->category_id ?>' type="text" id="form-field-1" placeholder="Category Name" class="col-xs-12 hidden" />
                                                <input name='category_name' value='<?php echo $category_info->category_name ?>' type="text" id="form-field-1" placeholder="Category Name" class="col-xs-12" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="col-md-4" for="form-field-1">Category Description</label>
                                            <div class="col-md-8">
                                                <textarea name='category_description' value='<?php echo $category_info->category_description ?>' class="form-control" id="form-field-8" placeholder="Category Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-lg-4 col-sm-4">
                                            <button class="btn btn-primary" type="submit"><i class="ace-icon fa fa-check bigger-110"></i>Update</button>
                                        </div>
                                        <div class="col-lg-4 col-sm-4">
                                            <!--<button class="btn btn-info" type="button"><i class="ace-icon fa fa-check bigger-110"></i>Submit</button>-->
                                        </div>
